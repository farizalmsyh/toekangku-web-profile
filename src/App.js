...
function App() {
  return (
    <div className="main-wrapper">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="single-blog">
                  ...
                  <div class="blog-content">
                    <div class="blog-meta">
                      <span>
                        <i class="fas fa-user"></i> <a href="#">Andrew Paker</a>
                      </span>
                      <span>
      ...
      <div class="section footer-section footer-section-03" style={{ backgroundImage: `url(assets/images/bg/footer-bg.jpg)` }}>
        <div class="container">
